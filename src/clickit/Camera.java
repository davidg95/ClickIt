...
public class Camera {
     ...
     * int.
     * @param price the price of the <code>Camera</code> as a double.
     * @param code the product code of the <code>Camera</code>.
     */
    public Camera(String make, String model, double megapixles, boolean ifFull, int stock, double price, String code) {
        this.make = make;
        this.model = model;
        this.megapixles = megapixles;
        this.full = ifFull;
