...
public class ProductList {
     ...
     *
     * @param sc the server connection class which handles communication with
     * the server.
     */
    public ProductList(ServerConnection sc) {
        this.sc = sc;
     ...
     * @throws ProductNotFoundException if the lens was not found.
     */
